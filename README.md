...
Olá, meu nome é Lucas, estudante de Engenharia de Software no Instituto Federal do Paraná (IFPR) e atualmente atuo em uma health tech de Belo Horizonte, chamada Ymunity, plataforma essa que auxilia na gestão de tratamentos de doenças imunobiológicos.<br>Atuando no projeto como front-end, onde utilizamos o framework Angular.<br>
 
 Contato e-mail: lucasrachid.raxas@gmail.com<br>
